...
var SqlCli = function () {
    ...
    SqlCli.prototype._printResult = function(result) {
        if (result && result.length > 0) {
            console.log(this._formatResult(result));
        }
        else {
            console.log();
        }
    ...
    SqlCli.prototype._formatResult = function(result) {
        ...
        return Table.printArray(result);
    };
